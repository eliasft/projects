...
#########################  GRAFICAS DE RESULTADOS   ##################### 
    ...
    ########## PLOTS POZOS TIPO
        ...
        Q_plot = sns.FacetGrid(tipos, col="tipo",hue='tipo',height=10, aspect=0.9)
        ...
        d_plot = sns.FacetGrid(tipos,col='tipo',hue='tipo',height=10,aspect=0.9)

...
########      ANALISIS DE DECLINACION DE POZOS      ####### 
    ...
    for pozo in unique_well_list:
        ...
        base=base.aceite_Mbd.append(base.aceite_Mbd,sort=False)

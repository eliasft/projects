...
df_info = pd.read_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/output/info_campo.csv')
df_info = df_info.transpose()
df_info = df_info.rename(columns={'':'Caracteristicas',0:'Datos'})

df_resumen = pd.read_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/output/resumen.csv',
                        header=0,
                        index_col=0)
...
dfxx = pd.read_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/output/serie_campo.csv')
...
df_tipos = pd.read_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/output/serie_tipos.csv',
                header=0,
                index_col=0
                )

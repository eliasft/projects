...
import input
input_campo = input.input_campo

from analisis_dca import hidrocarburo, gas, condensado, agua

import analisis_dca
serie_muestra = analisis_dca.serie_muestra
serie_campo = analisis_dca.serie_campo
fecha_muestra = analisis_dca.fecha_muestra

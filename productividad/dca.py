...
def pozos_tipo():
    ...
    ax6.plot(perfil.baja_M,label=None,linestyle='solid',color='red')
    ...
    ax6.plot(perfil.alta_M,label=None,linestyle='solid',color='green')
    ...
    ax7.plot(perfil.EUR_baja_M,label=None,linestyle='dashed',color='red',alpha=0.7)
    ...
    ax7.plot(perfil.EUR_media_M,label='EUR',linestyle='dashed',color='blue',alpha=0.7)
    ...
    ax7.plot(perfil.EUR_alta_M,label=None,linestyle='dashed',color='green',alpha=0.7)
    ...
    plot_alta.set_ylabel('Qo '+str(hidrocarburo))
    ...
    plot_media.set_ylabel('Qo '+str(hidrocarburo))
    ...
    plot_baja.set_ylabel('Qo '+str(hidrocarburo))
...
def generar_archivos():
    ...
    serie_campo.to_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/serie_campo.csv')
    serie_resumen.to_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/serie_resumen.csv')
    gasto.to_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/serie_gasto.csv')
    tipos.to_csv(r'/Users/fffte/Documents/GitHub/projects/productividad/serie_tipos.csv')
